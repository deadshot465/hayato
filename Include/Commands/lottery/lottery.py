...
class LotteryParticipant:
    ...
    def __init__(self, username: str, user_id: int, lottery_choices: List[List[int]], credits: int, last_daily_time: datetime.datetime, last_weekly_time: datetime.datetime):
