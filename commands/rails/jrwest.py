...
class JrWest(slash_commands.SlashSubCommand):
    ...
    _path = 'assets/rails/jrwest.json'
    _thumbnail = 'https://cdn.discordapp.com/attachments/734604988717858846/741817325732233268/JR_West.png'
    _formal_name = 'West Japan Railway Company'
    _short_name = 'JR West'
    _footer_name = 'JR West'
    _color = hikari.Color.of(0x0473bd)
    ...
    async def callback(self, context) -> None:
        ...
        if context.option_values.line_name == 'info':
            ...
            embed = Rails.build_single_result_embed(author_name, author_avatar_url, line,
                                                    self._footer_name, line['name'] + ' Line')
        else:
