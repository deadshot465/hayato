...
class Mtr(slash_commands.SlashSubCommand):
    ...
    _path = 'assets/rails/mtr.json'
    _thumbnail = 'https://cdn.discordapp.com/attachments/734604988717858846/739961151005130882/MTR.png'
    _formal_name = 'MTR'
    _short_name = _formal_name
    _footer_name = 'the MTR'
    _color = hikari.Color.of(0x9d2133)
